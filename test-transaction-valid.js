...
// Using product_id 15 which exists in the system (eSIM Spain)
const testData = {
  product_id: 15,
...
console.log('TRANSACTION API TEST - POST & GET (With Valid Product ID)');
console.log('='.repeat(70));
console.log();
  ...
  .then(async response => {
    ...
    if (data.transactions) {
      ...
      const testTransaction = transactions.find(t => 
        t.client_telegram === '@test_user_valid' && 
